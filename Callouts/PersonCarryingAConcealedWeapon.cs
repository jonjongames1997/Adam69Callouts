...
namespace Adam69Callouts.Callouts
{
    ...
    public class PersonCarryingAConcealedWeapon : Callout
    {
        ...
        public override void Process()
        {
            ...
            {
                Game.DisplayHelp("Press ~y~Y~w~ to interact with the suspect", false);
                ...
                if (Game.IsKeyDown(System.Windows.Forms.Keys.Y))
                {
                    ...
                    if (counter == 1)
                    {
                        ...
                        Game.DisplaySubtitle("~b~You~w~: LSPD, freeze, motherfucker!");
                    }
                    if (counter == 2)
                    {
                    ...
                    if (counter == 4)
                    {
                        Game.DisplaySubtitle("~r~Suspect~w~: What the fuck are you talking about? I don't have a weapon on me!");
                    }
                    if (counter == 5)
                    {
