namespace Adam69Callouts.VersionChecker
{
    public class PluginCheck
    {
        ...
        public static bool IsUpdateAvailable()
        {
            ...
            {
                Game.DisplayNotification("commonmenu", "mp_alerttriangle", "~w~Adam69 Callouts Warning", "~y~A new update is available!", "Current Version: ~r~" + curVersion + "~w~<br>New Version: ~y~" + recieveData + "<br>~w~Please Update to the latest build for new ~p~callouts~w~ and ~g~improvments~w~!:-)");
                Game.Console.Print();
                Game.Console.Print("===================================================== Adam69 Callouts ===========================================");
                Game.Console.Print();
